...
NISQ-era quantum computers.  The schedule is adaptive and the lecture plan from the spring 2026 (see below)
reflects the choices which can be made.

We discuss for example quantum for
