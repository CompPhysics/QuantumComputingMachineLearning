...
% --- begin date ---
\begin{center}
Spring semester 2026, deadline March 20
\end{center}
% --- end date ---
...
For the Bell states (one of your choice), you should also write a code
which traces out the density matrix for one subsystem and calculate
the von Neumann entropy and discuss the results.

% You can compare your code with the results obtained using for example software like \textbf{Qiskit}.
...
with either \textbf{Qiskit} or other software libraries like \textbf{Pennylane} or other.
