...
\begin{frame}{\week{Week 1 (Jan 19--23)} \ Basic Notions of Quantum Mechanics}
  ...
  \begin{alertblock}{Foundation}
    This week establishes the mathematical language used throughout
    the entire course.
  \end{alertblock}
\end{frame}
...
\begin{frame}{\week{Week 4 (Feb 9--13)} \ Entanglement, Entropies \& Quantum Gates}
  ...
  \begin{alertblock}{Bridge to VQE}
    Understanding gates and Hamiltonians prepares for
    \textbf{Project 1}: first exposure to the VQE algorithm.
  \end{alertblock}
\end{frame}
...
\begin{frame}{\week{Week 5 (Feb 16--20)} \ Getting Started with the VQE Algorithm}
  \begin{columns}[T]
    \column{0.55\textwidth}
      ...
      \end{block}
    \column{0.42\textwidth}
      \begin{alertblock}{Project 1 Launch}
...
\begin{frame}{\week{Weeks 7--8 (Mar 2--13)} \ VQE for the Lipkin Model \& Jordan-Wigner}
  ...
  \begin{alertblock}{Milestone}
    Project 1 results discussed; students have a working VQE solver.
  \end{alertblock}
\end{frame}
  ...
  \begin{columns}[T]
    \column{0.55\textwidth}
      \begin{block}{From NISQ to Fault-Tolerant Algorithms}
        \begin{itemize}
          \item Project 1 final discussions
...
\begin{frame}{\week{Weeks 10--11 (Mar 23 -- Apr 10)} \ QFT, Quantum Phase Estimation \& HHL}
  ...
  \begin{alertblock}{Note}
    No classes March 30 -- April 3 (public holiday in Norway).
  \end{alertblock}
\end{frame}
    ...
    \column{0.48\textwidth}
      \begin{block}{Applications \& Implementation}
        \begin{itemize}
          ...
          \item Codes, benchmarks, and Week 16\\
...
\begin{frame}{\week{Week 17 (May 18--22)} \ Quantum Boltzmann Machines}
  ...
  \begin{alertblock}{Course Conclusion}
    ...
    machine learning merge---a fitting capstone for the course.
  \end{alertblock}
\end{frame}
...
\begin{frame}{Summary: What You Will Learn}
  ...
  \begin{alertblock}{Overarching Goal}
    Equip physics graduate students with the theoretical foundations
