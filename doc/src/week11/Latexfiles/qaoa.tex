...
\centering
\begin{quantikz}
\lstick{$q_i$} & \ctrl{1} & \gate{$R_z(2\gamma)$} & \ctrl{1} \\
\lstick{$q_j$} & \targ{}  & \qw                  & \targ{}
\end{quantikz}
\end{frame}
...
\subtitle{Adiabatic Origins, Analytics, and Statistical Physics Connections}
\author{}
\date{}
...
\title{Quantum Approximate Optimization Algorithm}
\subtitle{From Adiabatic Dynamics to Statistical Physics and Control Theory}
\author{}
\date{}
