...
\begin{frame}[plain,fragile]
\frametitle{Plans for the week of March 31-April 4, 2025}
...
\begin{frame}[plain,fragile]
\frametitle{Brief reminder on Fourier transforms}
...
\begin{frame}[plain,fragile]
\frametitle{The discrete Fourier transform (DFT)}
...
\begin{frame}[plain,fragile]
\frametitle{QFT, short review from last week}
...
\begin{frame}[plain,fragile]
\frametitle{Advantage 1: Exponential Speedup}
...
\begin{frame}[plain,fragile]
\frametitle{Advantage 2: Quantum Parallelism}
...
\begin{frame}[plain,fragile]
\frametitle{Advantage 3: Compact Circuit Implementation}
...
\begin{frame}[plain,fragile]
\frametitle{Advantage 4: Applications in Quantum Computing}
...
\begin{frame}[plain,fragile]
\frametitle{Advantage 5: Reduced Memory Complexity}
...
\begin{frame}[plain,fragile]
\frametitle{Advantage 6: Quantum Signal Processing}
...
\begin{frame}[plain,fragile]
\frametitle{Short hand notation}
...
\begin{frame}[plain,fragile]
\frametitle{Quantum Fourier transform, more material}
...
\begin{frame}[plain,fragile]
\frametitle{Using computational basis}
...
\begin{frame}[plain,fragile]
\frametitle{Introduction to Quantum Phase Estimation (QPE)}
...
\begin{frame}[plain,fragile]
\frametitle{Quantum Circuit and Working}
...
\begin{frame}[plain,fragile]
\frametitle{Derivation of the Algorithm, Step 1: Initialization}
...
\begin{frame}[plain,fragile]
\frametitle{Step 2: Controlled Unitary Operations}
...
\begin{frame}[plain,fragile]
\frametitle{Step 3: Quantum Fourier Transform (QFT)}
...
\begin{frame}[plain,fragile]
\frametitle{Simple code which implements the QPE}
...
\begin{frame}[plain,fragile]
\frametitle{Code which implements the QPE using Qiskit}
...
\begin{frame}[plain,fragile]
\frametitle{Code which implements the QPE using PennyLane}
...
\begin{frame}[plain,fragile]
\frametitle{Applications of QPE}
...
\begin{frame}[plain,fragile]
\frametitle{Challenges and Practical Considerations}
