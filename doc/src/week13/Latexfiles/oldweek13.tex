...
\begin{frame}[plain,fragile]
\frametitle{Derivatives with respect to $b$ and $\bm{w}$}
...
\begin{enumerate}
\item Discussion of quantum support vector machines and quantum kernels

\item Introducing quantum neural networks
\end{enumerate}
