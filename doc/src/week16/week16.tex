...
%% doconce format latex week16.do.txt --minted_latex_style=trac --latex_admon=paragraph --no_mako
%%
...
% !split
\subsection*{Plan for the week of May 12-16}

% --- begin paragraph admon ---
\paragraph{}
\begin{enumerate}
\item Quantum Boltzmann Machines: Theory and Implementation
\begin{itemize}

  \item Quantum neural networks, wrapping up discussions from last week (see notes from last week at \href{{https://github.com/CompPhysics/QuantumComputingMachineLearning/blob/gh-pages/doc/pub/week15/ipynb/week15.ipynb}}{\nolinkurl{https://github.com/CompPhysics/QuantumComputingMachineLearning/blob/gh-pages/doc/pub/week15/ipynb/week15.ipynb}})

  \item Classical Boltzmann  Machines (BMs)

  \item Restricted Quantum Boltzmann Machines (RQBM)

  \item Training Quantum Boltzmann Machines

  \item Practical Implementation with PennyLane

\end{itemize}

\noindent
\item Summary of course and work on  project 2
\end{enumerate}
...
% !split
\subsection*{Classical Boltzmann machines (aka Energy models)}
...
% !split
\subsection*{Quantum Boltzmann Machines (QBMs)}
...
% !split
\subsection*{Restricted QBM (RQBM)}
...
% !split
\subsection*{Quantum Statistical Mechanics Background}
...
% !split
\subsection*{Energy-Based Training Objective and Gradients}
...
% !split
\subsection*{Analogy with classical RBM}
...
% !split
\subsection*{Parameter Optimization and Variational Techniques}
...
% !split
\subsection*{Implementation with PennyLane}
